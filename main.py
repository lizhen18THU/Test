...
def main(argv=None):
    ...
    # 任务种类与数据文件路径
    train_task = "final_train"
    test_task = "final_test"
    pre_train_test = False
    num_classes = 20  # 20分类/100分类
    print(num_classes, "classification " + train_task + " and " + test_task)

    # 网络和数据中间结果的读写路径
    statePath_read = "./halfState/state_WideResnet_final20.pth"
    statePath_write = "./halfState/state_WideResnet_final20.pth"
    listPath_read = "./halfState/list_WideResnet_final20.csv"
    listPath_write = "./halfState/list_WideResnet_final20.csv"
    ...
    # 测试数据集和迭代器
    testDataset = myDataset(picFile="./data/test.npy", labelFile="./data/train1.csv", task=test_task,
