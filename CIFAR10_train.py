...
def main(argv=None):
    ...
    # test_task = "pre_test"
    pre_train_test = True
    num_classes = 10  # 20分类/100分类
    # print(num_classes, "classification " + train_task + " and " + test_task)
    print("CIFAR10 train and test")

    # 网络和数据中间结果的读写路径
    statePath_read = "./halfState/state0_WideResNet_CIFAR10.pth"
    statePath_write = "./halfState/state0_WideResNet_CIFAR10.pth"
    listPath_read = "./halfState/list0_WideResNet_CIFAR10.csv"
    listPath_write = "./halfState/list_WideResNet_CIFAR10.csv"
    ...
    trainDataset=datasets.CIFAR10(root="./data", train=True, download=True, transform=transform_train)
    ...
    testDataset=datasets.CIFAR10(root="./data", train=False, download=True, transform=transform_test)
